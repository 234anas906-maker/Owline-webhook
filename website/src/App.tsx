    ...
    return <div className={Styles.app}>
        {(isDefault && page === '200.home') && <div className={Styles.alert}>
            ...
            <p><Trans t={t} i18nKey={"welcome.github"} components={{
                b: <b />,
                br: <br />,
                a: <a href="https://discord.gg/26tzM7yx95" target="_blank"/>,
            }} /></p>
            <p><button onClick={() => {
        ...
        <div className={Styles.json}>
            ...
            <a href="https://discord.gg/26tzM7yx95" target="_blank"><div className={Styles.badges}>
                <img alt="Star on GitHub"
                     src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh1MYRyyPftNcCBiddEJVehANmO2kdoxgwImP9yxP9PDdM1kMKDfKDk53CL_2-qJh8aZp3RVIfaLrOmfQkVlgg90Yr7jPpADr9I7tNzaUkCAeEnIO1lnopOgv-JzNM5lu4essvUsUkk49axEnBbzD4cgg_X0_W69knRdjzMU7OzpG8B5AaQX1Y7pHbTOtA/s320/Gemini_Generated_Image_2e2oa32e2oa32e2o.png" />
            ...
            <div className={Styles.footer}>
                ...
                <div><Trans t={t} i18nKey={"author"} components={{
                    a: <a href={"https://owlinebot.blogspot.com"} target={"_blank"} />
                }} /></div>
            </div>
        </div>
    </div>
